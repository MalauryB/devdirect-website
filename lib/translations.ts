export const translations = {
  fr: {
    ...
    profile: {
      ...
      legalFormPlaceholder: "SAS, SARL, SA, EURL...",
      siret: "SIRET",
      ...
      contactPositionPlaceholder: "Directeur, Responsable IT...",
    ...
    projects: {
      ...
      form: {
        ...
        servicesDesc: "Sélectionnez tous les services dont vous avez besoin",
        platforms: "Plateformes cibles",
        platformsDesc: "Sur quelles plateformes votre projet doit-il fonctionner ?",
        description: "Description du projet",
        descriptionDesc: "Décrivez votre projet en détail",
        generalDescription: "Description générale",
        descriptionPlaceholder: "Décrivez votre projet, ses objectifs, le contexte...",
        features: "Fonctionnalités principales",
        featuresPlaceholder: "Listez les fonctionnalités principales souhaitées...",
        targetAudience: "Public cible",
        targetAudiencePlaceholder: "Qui sont les utilisateurs finaux ?",
        existingProject: "Projet existant",
        existingProjectDesc: "Avez-vous déjà un projet en cours ?",
        newProject: "Non, c'est un nouveau projet",
        hasExisting: "Oui, j'ai déjà un projet",
        existingTech: "Technologies existantes",
        existingTechPlaceholder: "Quelles technologies sont actuellement utilisées ?",
        designTitle: "Design & Interface",
        designDesc: "Informations sur le design de votre projet",
        needsDesignYes: "Oui, je n'ai pas de design",
        needsDesignPartial: "Partiellement, j'ai quelques maquettes",
        needsDesignNo: "Non, j'ai déjà tous les designs",
        budgetTitle: "Budget et Délais",
        budgetDesc: "Informations sur votre budget et vos contraintes de temps",
        budget: "Budget estimé",
        budgetPlaceholder: "Sélectionnez une fourchette",
        deadline: "Délai souhaité",
        deadlinePlaceholder: "Sélectionnez un délai",
    ...
    quotes: {
      ...
      form: {
        ...
        // Step 2: Abaques
        step2Title: "Abaques",
        step2Desc: "Définissez les grilles de chiffrage par composant",
        noProfilesWarning: "Veuillez d'abord définir des profils dans l'étape 1",
        componentName: "Nom du composant",
        componentNamePlaceholder: "Ex: Page d'accueil, Formulaire contact...",
        selectProfile: "Profil",
        selectProfilePlaceholder: "Sélectionner un profil",
        ...
        complexity_c: "C",
        complexity_tc: "TC",
        complexity_ts_full: "Très Simple",
        complexity_s_full: "Simple",
        complexity_m_full: "Moyen",
        complexity_c_full: "Complexe",
        complexity_tc_full: "Très Complexe",
        daysPerComplexity: "Jours par complexité",
        addAbaque: "Ajouter un abaque",

        // Step 3: Activités transverses
        step3Title: "Activités transverses",
        step3Desc: "Définissez les activités transverses par niveau",
        transverseActivities: "Activités transverses",
        level: "Niveau",
        levelDesc: "Chaque niveau prend en compte le total des éléments de chiffrage et des niveaux inférieurs",
        addLevel: "Ajouter un niveau",
        removeLevel: "Supprimer ce niveau",
        activityName: "Nom de l'activité",
        activityNamePlaceholder: "Ex: Gestion de projet, Tests...",
        activityType: "Type",
        typeFixed: "Fixe",
        typeRate: "Taux",
        activityValue: "Valeur",
        valueDays: "jours",
        valuePercent: "%",
        addActivity: "Ajouter une activité",
        noLevelsWarning: "Ajoutez au moins un niveau d'activités",

        // Step 4: Éléments de chiffrage
        step4Title: "Éléments de chiffrage",
        step4Desc: "Organisez les éléments à chiffrer par catégorie et activité",

        // Catégories
        category: "Catégorie",
        categoryName: "Nom de la catégorie",
        categoryNamePlaceholder: "Ex: Front-end, Back-end, Infrastructure...",
        addCategory: "Ajouter une catégorie",
        removeCategory: "Supprimer cette catégorie",

        // Activités de chiffrage
        costingActivity: "Activité",
        costingActivityName: "Nom de l'activité",
        costingActivityNamePlaceholder: "Ex: Développement page d'accueil...",
        activityActive: "Actif",
        addCostingActivity: "Ajouter une activité",

        // Composants
        costingComponent: "Composant",
        selectComponent: "Composant (abaque)",
        selectComplexity: "Complexité",
        coefficient: "Coef",
        componentComment: "Commentaire",
        componentCommentPlaceholder: "Notes sur ce composant...",
        addComponent: "Ajouter un composant",

        // Complexités
        complexity_ts_short: "TS",
        complexity_s_short: "S",
        complexity_m_short: "M",
        complexity_c_short: "C",
        complexity_tc_short: "TC",

        noCategoriesWarning: "Ajoutez au moins une catégorie",
        noAbaquesWarning: "Veuillez d'abord définir des abaques dans l'étape 2",

        // Step 5: Récapitulatif
        step5Title: "Récapitulatif et conditions",
        step5Desc: "Vérifiez et finalisez le devis",
    ...
    messages: {
      title: "Messages",
      sectionDescription: "Échangez avec notre équipe sur vos projets",
    ...
    documents: {
      ...
      uploadModal: {
        ...
        namePlaceholder: "Ex: Devis signé - Janvier 2024",
      ...
      uploadNewVersion: "Envoyer une nouvelle version",
    ...
    finances: {
      title: "Finances",
      subtitle: "Visualisez les données financières du projet",
      totalBudget: "Budget total",
      totalBudgetHT: "Budget HT",
      totalBudgetTTC: "Budget TTC",
      ...
      consumedValue: "Valeur consommée",
      profileBreakdown: "Répartition par profil",
      monthlyEvolution: "Évolution mensuelle",
      categoryBreakdown: "Répartition par catégorie",
      cumulativeDays: "Jours cumulés",
      budgetVsConsumed: "Budget vs Consommé",
      budget: "Budget",
      consumed: "Consommé",
      noData: "Aucune donnée financière",
      noDataDescription: "Créez un devis accepté ou un contrat signé pour voir les données financières du projet.",
      ...
      profile: "Profil",
      dailyRate: "TJM",
      budgetDays: "Jours budget",
      consumedDays: "Jours consommés",
      amount: "Montant",
      // Global finances
      globalTitle: "Finances globales",
      globalSubtitle: "Vue consolidée de tous les projets",
      totalProjects: "Projets",
      projectsWithBudget: "Avec budget",
      ...
      noGlobalData: "Aucune donnée financière",
      noGlobalDataDescription: "Les données financières apparaîtront ici lorsque des devis seront acceptés ou des contrats signés.",
      contractsWithoutProfiles: "Contrats régie sans profils TJM",
      contractsWithoutProfilesDescription: "Les contrats suivants sont signés mais n'ont pas de profils TJM définis. Leur budget ne peut pas être calculé.",
      goToContracts: "Aller aux contrats"
    },
    globalDocuments: {
      title: "Documents globaux",
      subtitle: "Templates et ressources partagées de l'entreprise",
      ...
      upload: "Ajouter",
      uploadFirst: "Ajouter un document",
      uploadTitle: "Ajouter un document",
      uploadDescription: "Uploadez un template ou une ressource partagée",
      dropOrClick: "Glissez un fichier ou cliquez pour sélectionner",
      documentName: "Nom du document",
      namePlaceholder: "Ex: Template présentation client",
      description: "Description",
      descriptionPlaceholder: "Description optionnelle...",
      type: "Type",
      category: "Catégorie",
      categoryPlaceholder: "Ex: Commercial, Technique...",
      name: "Nom",
      size: "Taille",
      version: "Version",
      ...
      deleteDescription: "Êtes-vous sûr de vouloir supprimer ce document ? Cette action est irréversible.",
      noDocuments: "Aucun document",
      noDocumentsDescription: "Ajoutez des templates PowerPoint, signatures email, chartes graphiques et autres ressources partagées."
    },
    roadmap: {
      title: "Roadmap",
    ...
    contracts: {
      ...
      annexesSection: "Annexes du contrat",
      annexesSectionHint: "Sélectionnez les documents à inclure comme annexes dans le PDF du contrat",
      annexe1SignedQuote: "Annexe 1 : Devis signé",
      annexe2Specification: "Annexe 2 : Cahier des charges",
      annexe3Planning: "Annexe 3 : Planning prévisionnel",
      selectDocument: "Sélectionner un document",
      noDocumentSelected: "Aucun document sélectionné",
      noSignedQuoteAvailable: "Aucun devis signé disponible. Uploadez-en un dans l'espace Documents.",
      noSpecificationAvailable: "Aucun cahier des charges disponible. Uploadez-en un dans l'espace Documents.",
      noPlanningAvailable: "Aucun planning disponible. Uploadez-en un dans l'espace Documents.",
  ...
  en: {
    ...
    profile: {
      ...
      legalFormPlaceholder: "LLC, Inc., Ltd...",
      siret: "Company registration number",
      siretPlaceholder: "123 456 789 00012",
      vatNumber: "VAT number",
      vatNumberPlaceholder: "GB123456789",
      professionalEmail: "Professional email",
      professionalEmailPlaceholder: "contact@company.com",
      contactPosition: "Contact position",
      contactPositionPlaceholder: "Director, IT Manager...",
    ...
    projects: {
      ...
      budget: {
        ...
        medium: "€5,000 - €15,000",
        large: "€15,000 - €50,000",
        xlarge: "More than €50,000",
        flexible: "Flexible / To discuss"
      },
      deadline: {
      ...
      form: {
        ...
        servicesDesc: "Select all services you need",
        platforms: "Target platforms",
        platformsDesc: "On which platforms should your project run?",
        description: "Project description",
        descriptionDesc: "Describe your project in detail",
        generalDescription: "General description",
        descriptionPlaceholder: "Describe your project, its objectives, the context...",
        features: "Main features",
        featuresPlaceholder: "List the main desired features...",
        targetAudience: "Target audience",
        targetAudiencePlaceholder: "Who are the end users?",
        existingProject: "Existing project",
        existingProjectDesc: "Do you already have an ongoing project?",
        newProject: "No, this is a new project",
        hasExisting: "Yes, I already have a project",
        existingTech: "Existing technologies",
        existingTechPlaceholder: "What technologies are currently used?",
        designTitle: "Design & Interface",
        designDesc: "Information about your project's design",
        needsDesignYes: "Yes, I don't have a design",
        needsDesignPartial: "Partially, I have some mockups",
        needsDesignNo: "No, I already have all the designs",
        budgetTitle: "Budget and Timeline",
        budgetDesc: "Information about your budget and time constraints",
    ...
    quotes: {
      ...
      form: {
        ...
        // Step 2: Abaques
        step2Title: "Pricing grids",
        step2Desc: "Define pricing grids per component",
        noProfilesWarning: "Please define profiles in step 1 first",
        componentName: "Component name",
        componentNamePlaceholder: "E.g.: Homepage, Contact form...",
        ...
        complexity_c: "C",
        complexity_tc: "VC",
        complexity_ts_full: "Very Simple",
        complexity_s_full: "Simple",
        complexity_m_full: "Medium",
        complexity_c_full: "Complex",
        complexity_tc_full: "Very Complex",
        daysPerComplexity: "Days per complexity",
        addAbaque: "Add a pricing grid",

        // Step 3: Transverse activities
        step3Title: "Transverse activities",
        step3Desc: "Define transverse activities by level",
        transverseActivities: "Transverse activities",
        level: "Level",
        levelDesc: "Each level takes into account the total of costing elements and lower levels",
        addLevel: "Add a level",
        removeLevel: "Remove this level",
        activityName: "Activity name",
        activityNamePlaceholder: "E.g.: Project management, Testing...",
        activityType: "Type",
        typeFixed: "Fixed",
        typeRate: "Rate",
        activityValue: "Value",
        ...
        noLevelsWarning: "Add at least one level of activities",

        // Step 4: Costing elements
        step4Title: "Costing elements",
        step4Desc: "Organize items to be costed by category and activity",

        // Categories
        category: "Category",
        categoryName: "Category name",
        categoryNamePlaceholder: "E.g.: Front-end, Back-end, Infrastructure...",
        addCategory: "Add a category",
        removeCategory: "Remove this category",

        // Costing activities
        costingActivity: "Activity",
        costingActivityName: "Activity name",
        costingActivityNamePlaceholder: "E.g.: Homepage development...",
        activityActive: "Active",
        addCostingActivity: "Add an activity",

        // Components
        costingComponent: "Component",
        selectComponent: "Component (pricing grid)",
        selectComplexity: "Complexity",
        coefficient: "Coef",
        componentComment: "Comment",
        componentCommentPlaceholder: "Notes about this component...",
        addComponent: "Add a component",

        // Complexities
        complexity_ts_short: "VS",
        complexity_s_short: "S",
        complexity_m_short: "M",
        complexity_c_short: "C",
        complexity_tc_short: "VC",

        noCategoriesWarning: "Add at least one category",
        noAbaquesWarning: "Please define pricing grids in step 2 first",

        // Step 5: Summary
        step5Title: "Summary and conditions",
        step5Desc: "Review and finalize the quote",
    ...
    messages: {
      title: "Messages",
      sectionDescription: "Exchange with our team about your projects",
    ...
    documents: {
      ...
      uploadModal: {
        title: "Add document",
        name: "Document name",
        namePlaceholder: "E.g.: Signed quote - January 2024",
    ...
    finances: {
      title: "Finances",
      subtitle: "View project financial data",
      totalBudget: "Total budget",
      totalBudgetHT: "Budget excl. VAT",
      totalBudgetTTC: "Budget incl. VAT",
      ...
      profileBreakdown: "Breakdown by profile",
      monthlyEvolution: "Monthly evolution",
      categoryBreakdown: "Breakdown by category",
      cumulativeDays: "Cumulative days",
      budgetVsConsumed: "Budget vs Consumed",
      budget: "Budget",
      consumed: "Consumed",
      noData: "No financial data",
      noDataDescription: "Create an accepted quote or signed contract to view project financial data.",
      ...
      amount: "Amount",
      // Global finances
      globalTitle: "Global Finances",
      globalSubtitle: "Consolidated view of all projects",
      totalProjects: "Projects",
      projectsWithBudget: "With budget",
      ...
      noGlobalData: "No financial data",
      noGlobalDataDescription: "Financial data will appear here when quotes are accepted or contracts are signed.",
      contractsWithoutProfiles: "T&M contracts without profiles",
      contractsWithoutProfilesDescription: "The following contracts are signed but have no daily rate profiles defined. Their budget cannot be calculated.",
      goToContracts: "Go to contracts"
    },
    globalDocuments: {
      title: "Global Documents",
      subtitle: "Company-wide templates and shared resources",
      ...
      upload: "Add",
      uploadFirst: "Add a document",
      uploadTitle: "Add a document",
      uploadDescription: "Upload a template or shared resource",
      dropOrClick: "Drag a file or click to select",
      documentName: "Document name",
      namePlaceholder: "E.g., Client presentation template",
      description: "Description",
      descriptionPlaceholder: "Optional description...",
      type: "Type",
      category: "Category",
      categoryPlaceholder: "E.g., Commercial, Technical...",
      name: "Name",
      size: "Size",
      version: "Version",
      uploadedBy: "Uploaded by",
      ...
      noDocumentsDescription: "Add PowerPoint templates, email signatures, brand guidelines and other shared resources."
    },
    roadmap: {
      title: "Roadmap",
    ...
    contracts: {
      ...
      annexesSection: "Contract Annexes",
      annexesSectionHint: "Select documents to include as annexes in the contract PDF",
      annexe1SignedQuote: "Annex 1: Signed Quote",
      annexe2Specification: "Annex 2: Specifications",
      annexe3Planning: "Annex 3: Project Planning",
      selectDocument: "Select a document",
      noDocumentSelected: "No document selected",
      noSignedQuoteAvailable: "No signed quote available. Upload one in the Documents section.",
      noSpecificationAvailable: "No specifications available. Upload one in the Documents section.",
      noPlanningAvailable: "No planning available. Upload one in the Documents section.",
