    ...
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-96 max-w-[calc(100vw-3rem)] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden" style={{ height: '500px', maxHeight: 'calc(100vh - 8rem)' }}>
          {/* Header */}
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-4 py-3 flex items-center gap-3">
            ...
            {messages.map((message) => (
              ...
              >
                <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                  message.role === 'user' ? 'bg-gray-900 text-white' : 'bg-purple-100 text-purple-600'
                }`}>
          ...
          <div className="p-4 border-t border-gray-100">
            <div className="flex gap-2">
              <Textarea
                ...
                className="resize-none min-h-[44px] max-h-[120px] border-gray-200 focus:border-purple-400 rounded-xl"
                rows={1}
                disabled={loading}
              />
              <Button
                ...
                className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 rounded-xl px-4"
              >
                {loading ? (
